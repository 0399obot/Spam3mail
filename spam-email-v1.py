...
try:
	file1 = open("v1.txt", "r")
	print(" ")
	print(bcolors.WHITE + file1.read() + bcolors.ENDC)
	file1.close()
except IOError:
...
""" + bcolors.ENDC + "")
try:
	server = input(bcolors.WHITE + "Mail Server: " + bcolors.ENDC)
	user = input(bcolors.WHITE + "Your Email: " + bcolors.ENDC)
	pwd = getpass.getpass(bcolors.WHITE + "Password: " + bcolors.ENDC)
	to = input(bcolors.WHITE + "To: " + bcolors.ENDC)
	subject = input(bcolors.WHITE + "Subject (Optional): " + bcolors.ENDC)
	body = input(bcolors.WHITE + "Message: " + bcolors.ENDC)
	nomes = input(bcolors.WHITE + "Number of Emails to send: " + bcolors.ENDC)
	no = 0
	message = "From: " + user + "\nSubject: " + subject + "\n" + body
